...
- Первый секрет: 
Name: `​​​​TG_TOKEN​​​​` . Secret: скопировать токен из @botFather, который получил при создании бота на шаге #8

- Второй секрет:
Name: `​​​​TG_ID1​​​​` . Secret: прописать айди своего аккаунта (узнай у https://t.me/userinfobot)
