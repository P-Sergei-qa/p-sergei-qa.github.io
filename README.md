...
2. Скачай все обновления из репозитория: `​​​​git pull​​​​`
3. Добавь в корень проекта папку командой ​​​​`​​mkdir .github​​`. Чтобы её увидеть, можно использовать команду `​​​​​​ls -la​​​​​​`
4. Перейди в папку  `​​​​.github​​​​ ` (команда ​​ `​​cd .github​​​ `)
5. ​Добавь внутри папки ​​​​`.github`​​​​ папку ​​​​`workflows`​​​​ (обязательно с маленькой буквы, команда ​​​​`​​​​mkdir workflows​​​​`​​​​ )
6. Добавь в папку ​​​​workflows​​​​ файл ​​​​cicd.yml [`cicd.yml`](https://github.com/P-Sergei-qa/p-sergei-qa.github.io/tree/main/.github/workflows) В этом ямл файле и содержится готовая настройка твоего ci/cd: как пульт управления.
7. Сохрани и запушь изменения:
а) ​​​​`git add .`​​​​
б) ​​​​`git commit -m "добавил ямл"​​​​`
в)`​​​​git push​​`

8. Создай бота в телеграм: @botFather и там команда ​​​​​​​​`/newbot​​​​​​​​`
- Назови его, например ​​​​CI CD​​​​
- Дай ему адрес, например, ​​​​`Name_ci_cd_bot​​​​`
- Botfather пришлёт в ответ ​​​​token
- Зайди в аккаунт созданного бота и нажми там ​​​​`​​​​/start​​​​​​​​`

9. В репозитории на GitHub (не общие настройки, а именно конкретного репозитория)  зайди в настройки секретов: Settings -> Secrets and variables -> Actions
10. Создай два секрета (New repository secret):
Первый секрет: 
Name: `​​​​TG_TOKEN​​​​`
Secret: скопируй токен из @botFather, который получил при создании бота на шаге #8

Второй секрет:
Name: `​​​​TG_ID1​​​​`
Secret: пропиши айди своего аккаунта (узнай у https://t.me/userinfobot)
*В итоге должно быть два секрета*

11. Можно запускать сборку ветки вручную:
...
16. [Скачать](https://github.com/P-Sergei-qa/p-sergei-qa.github.io) ZIP-архив, нажав кнопку `Code` справа над списком файлов, а затем - `Download ZIP` и распаковать архив.
17. Загрузить папку "snowFlakes" с файлами себе на хостинг. Остальные файлы не нужны.
18. Подключить css-стили и js-скрипт:
